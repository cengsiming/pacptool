...
class Scan:
    ...
    def lay(self):
        ...
        self.franme1.pack(pady=5, padx=20)
        self.franme2 = ttk.Frame(self.window)
        self.franme2.pack(pady=5, padx=20)
        self.franme3 = ttk.Frame(self.window)
        self.franme3.pack(pady=5, padx=20)

        ttk.Label(self.franme1,text='IP:').pack(side=ttk.LEFT, padx=10)
        self.l4=ttk.Entry(self.franme1,width=45,)
        self.l4.pack(side=ttk.LEFT)

        ttk.Label(self.franme2,text='Port:').pack(side=ttk.LEFT, padx=4)
        self.l5=ttk.Entry(self.franme2,width=45,)
        self.l5.pack(side=ttk.LEFT)
        ...
        self.l6.pack(side=ttk.LEFT, padx=30)

        self.l2=ttk.Button(self.franme3,text="确定",command=self.commit)
        self.l2.pack(side=ttk.LEFT, padx=30)

        self.l3=ttk.ScrolledText(self.window,width=55,height=20)
